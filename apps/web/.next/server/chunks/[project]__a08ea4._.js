...
"[project]/apps/web/app/api/agent/plan/route.ts [app-route] (ecmascript)": (({ r: __turbopack_require__, f: __turbopack_module_context__, i: __turbopack_import__, s: __turbopack_esm__, v: __turbopack_export_value__, n: __turbopack_export_namespace__, c: __turbopack_cache__, M: __turbopack_modules__, l: __turbopack_load__, j: __turbopack_dynamic__, P: __turbopack_resolve_absolute_path__, U: __turbopack_relative_url__, R: __turbopack_resolve_module_id_path__, g: global, __dirname, x: __turbopack_external_require__, y: __turbopack_external_import__ }) => (() => {
"use strict";
...
async function POST(req) {
    try {
        ...
        const [policies, wallet, opportunities] = await Promise.all([
            ...
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["queryWalletState"])(),
        ...
        const orchestrator = new __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$agent$2d$core$2f$src$2f$agent$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["AgentOrchestrator"]();
        orchestrator.configureFromEnv(); // no-op if no LLM_API_KEY set
        orchestrator.setPolicies(typedPolicies);
...
//# sourceMappingURL=%5Bproject%5D__a08ea4._.js.map